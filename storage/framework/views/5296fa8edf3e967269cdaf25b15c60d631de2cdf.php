...
<div class="container my-4">
    <div class="row">
        <!-- start of content -->
        <div class="col-sm-12 col-xs-12 bg-color-silver"><h3>تعديل إعلان : <span style="color: #ff0000"><?php echo e($adv->title); ?></span></h3></div>
        ...
        <div class="col-md-12 bg-color-white border-all p-5">
            <form id="my_form" action="<?php echo e(url('/adv_action/'.$adv->id)); ?>" method="post" enctype="multipart/form-data" class="form-group">
...
// case 1
        $('#main_section').on('change', function () {
            ...
            $.ajax({
                url: "<?php echo e(url('/bottom_filter1_a')); ?>",
                type: "post",
...
// case 2
        $('#sub_section').on('change', function () {
            ...
            $.ajax({
                url: "<?php echo e(url('/bottom_filter2_a')); ?>",
                type: "post",
                data: {'main_section_id': main_section_id,
