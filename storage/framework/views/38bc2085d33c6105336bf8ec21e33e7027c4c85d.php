<?php $__env->startSection('content'); ?>
    <div class="container-fluid padding-r-l-50 " style="background: #F0F3F8;">
        ...
        <div class="col-sm-3 pull-left">
            <a href="<?php echo e(url('/area/create')); ?>" type="button" class="btn btn-primary btn-block">
        ...
        <div class="col-sm-12">
            <div class="table-responsive">
                <table class="table table-hover">
                    ...
                    <tbody>
                    <?php if(count($area) > 0): ?>
                        <?php for($i=0;$i<$area->count();$i++): ?>
                            <tr>
                                <td><?php echo e($i+1); ?></td>
                                <td><?php echo e($area[$i]->name); ?></td>
                                <td>
                                    <a style="margin-left: 25px" href="<?php echo e(url('/area/'.$area[$i]->id.'/edit')); ?>" class="btn btn-info pull-right"><i class="fa fa-pencil"></i>&nbsp;&nbsp; تعديل</a>
                                    <form onsubmit="return confirm('سوف يتم حذف جميع المدن والمستخدمين والإعلانات المرتبطين بهذه المنطقة ... هل تريد الحذف بالفعل؟');" action="<?php echo e(url('/area/'.$area[$i]->id)); ?>" method="post">
        ...
        <div class="col-sm-12 text-center">
            <?php echo e($area->onEachSide(1)->appends(Request::capture()->except('page'))->render()); ?>
