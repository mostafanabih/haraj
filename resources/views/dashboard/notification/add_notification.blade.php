...
@section('content')
    <div class="container-fluid padding-r-l-50" style="background: #F0F3F8;">
        ...
        <div class="col-sm-12"><h2>إضافة إشعار جديد :</h2></div>
        <form id="my_submit_form" action="{{ url('/notification') }}" method="post" class="form-group">
            @csrf
            <div class="col-sm-12">
            ...
            <div class="col-sm-12">
                <div class="form-group">
                    ...
                    <input type="text" name="adv_id" id="adv_id" value="@if(request('id')) {{ request('id') }} @else {{ old('adv_id') }} @endif" class="form-control"
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if(data == '<span class="text-danger">رقم الإعلان الذى أدخلته غير صحيح</span>'){
                            $('#my_submit_form_btn').prop('disabled', true);
                        }else{
                            $('#my_submit_form_btn').prop('disabled', false);
                        }
                    }
                });
            });
