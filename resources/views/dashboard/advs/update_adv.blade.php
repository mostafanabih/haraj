...
<div class="container my-4">
    <div class="row">
        <!-- start of content -->
        <div class="col-sm-12 col-xs-12 bg-color-silver"><h3>تعديل إعلان : <span style="color: #ff0000">{{ $adv->title }}</span></h3></div>
        ...
        <div class="col-md-12 bg-color-white border-all p-5">
            <form id="my_form" action="{{ url('/adv_action/'.$adv->id) }}" method="post" enctype="multipart/form-data" class="form-group">
                {{method_field('PUT')}}
                @csrf
