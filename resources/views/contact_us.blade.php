...
<div class="container my-4">
    <div class="row">
        ...
        <div class="col-xs-12 bg-color-silver border-all">
            <h3 class="color-silver-darker"><a href="{{ url('/') }}" class="color-silver-darker">الرئيسية</a> / <a href="{{ url('/ContactUs') }}" class="color-black">اتصل بنا</a></h3>
        </div>
                ...
                <div class="col-md-12 col-xs-12 bg-color-white">
                    <div class="m-4 border-all text-center">
                        <ul class="list-inline list-unstyled">
                            <li>
                                <img alt="logo" src="@if(is_null($info->logo)) {{ asset('public/img/logo.png') }} @else {{ asset('public/img/'.$info->logo) }} @endif">
                            </li>
                            <li class="">
                    ...
                    <div class="pt-4 m-4">
                        <h4 class="color-gold pb-4 border-bottom">العنوان : <span class="color-black">{{ $info->address }}</span></h4>
                        <h4 class="color-gold pb-4 pt-4 border-bottom">الهاتف : <span class="color-black">{{ $info->mobile }}</span></h4>
                        <h4 class="color-gold pb-4 pt-4 border-bottom">فاكس : <span class="color-black">{{ $info->fax }}</span></h4>
                        <h4 class="color-gold pt-4">البريد : <span class="color-black">{{ $info->e_mail }}</span></h4>
                        {{--<h4 class="color-gold pb-5 pt-4">تويتر : <span style="direction: ltr; display: inline-block" class="color-black">@HarajOne</span></h4>--}}
                        {{--<div class="padding-top-50"><br></div>--}}
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-xs-12">
                ...
                <div class="col-md-12 col-xs-12 bg-color-white p-4">
                    <form action="{{ route('ContactUsSend') }}" method="post" class="form-group">
                        @csrf
                        ...
                        {{--<div class="col-xs-12"><input type="text" name="title" class="form-control input-lg mb-3" placeholder="عنوان الرسالة ..." required></div>--}}
